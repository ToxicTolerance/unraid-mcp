...
def register_rclone_tools(mcp: FastMCP) -> None:
    ...
    async def create_rclone_remote(
        name: str, provider_type: str, parameters: dict[str, Any]
    ) -> dict[str, Any]:
        """
        ...
        Args:
            ...
            parameters: Configuration parameters specific to the provider type
        """
        try:
            mutation = """
            ...
            variables = {"input": {"name": name, "type": provider_type, "parameters": parameters}}
